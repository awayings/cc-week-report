...
```
  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
    AI 开发周报  2026-05-07 ~ 2026-05-14
  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

  会话总数: 13 | 输入: 1,525,898 tokens | 输出: 125,702 tokens
  平均时长: 24.5 min | 成本: $6.46 | 输入输出比: 12.1

  ── 流畅度仪表板 ──

   人工输入频次    13.8/hr      AI 自主运行    11.6 min
   交互时长        24.5 min     被打断率       13.3%
   工具调用密度    0.50/rsp     Cache 命中率   0%
   工具错误率      9.5%         需求完成率     0%

  ── 项目 douyin-downloader (4 sessions, 561K/67K) ──

    本周主要围绕抖音下载工具的环境配置与实际下载尝试展开：成
    功在 CLAUDE.md 顶部补充了 venv 启动说明，但后续两次尝
    试下载视频均卡在 Playwright/Chromium 安装环节，cookie
    获取和视频拉取流程未能跑通，用户多次重定向后仍未完成。

    流畅度: ██████░░░░ 中断率 36% | 自主运行 16min
```
